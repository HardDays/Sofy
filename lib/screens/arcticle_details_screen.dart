...
class _ArticlesDetailsScreenState extends State<ArticlesDetailsScreen> {
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                            colors: [Color(0xFFFDF3FF), Color(0xffF9EAF7)],
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: LinearProgressIndicator(
                        ...
                        valueColor:
                            AlwaysStoppedAnimation<Color>(Color(0xffFEA9BC)),
                        value: scroll.value,
                      ),
                    ),
                  ),
  ...
  Widget _dividerWithVotes(BuildContext context) => Padding(
        ...
        child: Row(
          ...
          children: [
            Container(
                height: 1.0, width: width / 3, color: const Color(0x50edc3ed)),
            Container(
              margin: EdgeInsets.only(left: 21.0),
              child: SvgPicture.asset(
                'assets/svg/article_votes.svg',
                color: const Color(0xffEDC3ED),
              ),
            ),
            Container(
  ...
  Widget _dividerWithStars(BuildContext context) => Padding(
        ...
        child: Row(
          ...
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            Container(height: 1.0, width: width / 3, color: Color(0x50edc3ed)),
            Container(
              margin: EdgeInsets.only(left: 21.0),
              child: SvgPicture.asset(
