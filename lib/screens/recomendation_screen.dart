...
//                  'Рекомендованные',
                ...
                return Swiper(
                  ...
                  itemBuilder: (context, index) {
                    return _themeContainer(
                        playlistsData.apiPlaylistsForRecomendScreen[index],
                        itemWidth: itemWidth,
                        itemHeight: itemHeight);
                  },
                );
  ...
  Widget _miniContainer(apiVibrationModel) {
    ApiVibrationModel _apiVibrationModel = apiVibrationModel;
    return Stack(
      children: <Widget>[
        Stack(
          children: <Widget>[
            Container(
              ...
              child: ClipRRect(
                ...
                child: PlayListLeadWidget(
                  url: _apiVibrationModel.coverImg,
                  created: _apiVibrationModel.dateCreated,
                  height: height / 5.2,
                  width: width / 2.9,
                ),
              ),
                ...
                child: Padding(
                  ...
                  child: Text(
                    AppLocalizations.of(context).languageCode() == 'ru'
                        ? _apiVibrationModel?.titleRu
                        : _apiVibrationModel?.titleEn,
//                                            'Полет бабочки',
        ...
        Positioned(
          child: Visibility(
            ...
            visible: !_apiVibrationModel?.isTrial ?? true,
            child: Container(
                ...
                onTap: () {
                  ...
                  bool isAppPurchase =
                      Provider.of<SubscribeData>(context, listen: false)
                          .isAppPurchase;
                  if (isAppPurchase ||
                      (!isAppPurchase && _apiVibrationModel.isTrial)) {
                    playlistData.updateCurrentPlayListModelApi(
                      model: _apiVibrationModel,
                      notify: false,
                    );
                    ...
                    Future.delayed(Duration(milliseconds: 250), () {
                      ...
                      player.startVibrate(
                        vibrations: _apiVibrationModel.data,
                      ...
                      Analytics().sendEventReports(
                        ...
                        attr: {
                          'vibration_id': playlistData
                              ...
                              .dateCreated,
                          'playlist_id': Provider.of<PlaylistNameData>(context,
                                  listen: false)
                              .getCurrentPlaylistNameApi()
                              .titleEn,
                          'source': 'playlist_' +
  ...
  Widget _themeContainer(apiPlayListModel,
      {@required itemWidth, @required itemHeight}) {
    ApiPlayListModel _apiPlayListModel = apiPlayListModel;
    return Padding(
            ...
            children: <Widget>[
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    ...
                    imageUrl: _apiPlayListModel?.coverImg,
                    fit: BoxFit.fill,
                  ),
                ),
              ),
              ...
              Container(
                ...
                child: Container(
                  ...
                  child: Padding(
                    padding: EdgeInsets.only(left: width / 17.35),
                    child: Text(
                      AppLocalizations.of(context)
