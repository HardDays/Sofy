...
class ArticlesScreen1 extends StatefulWidget {
  @override
  _ArticlesScreenState1 createState() => _ArticlesScreenState1();
}

class _ArticlesScreenState1 extends State<ArticlesScreen1>
    with AutomaticKeepAliveClientMixin {
  bool isLoading = true;
  double height, width;
  int currentIndex = 0;
