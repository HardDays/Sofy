...
class ArticlesCategoriesDetailsScreen extends StatefulWidget {
  ...
  ArticlesCategoriesDetailsScreen({Key key, @required this.screenTitle, @required this.categoryId})
      : super(key: key);
                            ...
                            return Stack(
                              children: <Widget>[
                                ...
                                Visibility(
                                    ...
                                    visible: articlesList[index].isPaid == 1 ? true : false,
                                    child: Container(
                                      height:
                                          ...
                                          if (articlesList[index].isPaid == 1) {
                                            if (isAppPurchase) {
                                              Navigator.of(context).push(MaterialPageRoute(
                                                  builder: (BuildContext context) => ArticlesDetailsScreen(articleId: articlesList[index].id.toString())));
                                              /*Analytics().sendEventReports(
                                              ...
                                              Navigator.push(context, MaterialPageRoute( builder: (context) =>SubscribeScreen(isFromSplash: false),),);
                                            }
                                          } else {
                                            Navigator.of(context).push(MaterialPageRoute(
                                                builder: (BuildContext context) => ArticlesDetailsScreen(articleId: articlesList[index].id.toString())));
