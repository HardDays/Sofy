package com.enjoysofy.app.plugin;
...
public class VibrationPlugin implements MethodCallHandler {
    ...
    private VibrationPlugin(Context context) {
    ...
    public static void registerWith(FlutterEngine flutterEngine, Context context) {
        ...
        channel.setMethodCallHandler(new VibrationPlugin(context));
    }
